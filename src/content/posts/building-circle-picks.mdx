...
4. **The community around AI tooling is real.** Tools like [TokenCentric](https://www.tokencentric.app/) from Hel Rabelo, the [PHL Boilerplate](https://boilerplate.pedrohlima.com/) from Pedro. The ecosystem of developers building tools to make AI-assisted development better is growing fast.
