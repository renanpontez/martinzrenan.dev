...
<div style={{display: 'flex', gap: '1.5rem', justifyContent: 'center', margin: '2rem 0'}}>
  <img src="/blog/circle-picks/mobile-feed.png" alt="Circle Picks mobile app — Friends' Suggestions feed" style={{width: '48%', maxWidth: '300px', borderRadius: '0.75rem', border: '1px solid var(--border)'}} />
  <img src="/blog/circle-picks/mobile-how-it-works.png" alt="Circle Picks mobile app — How it works" style={{width: '48%', maxWidth: '300px', borderRadius: '0.75rem', border: '1px solid var(--border)'}} />
</div>
